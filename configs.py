...
from dataset import *
from models import *
from Imagefolder_modified import *
...
def get_datasets(dataset, augment_clf_train=False, add_indices_to_data=False, num_positive=None):
    ...
    CACHED_MEAN_STD = {
        ...
        'cub':((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    }

    PATHS = {
        'cifar10': '/data/cifar10/',
        'cifar100': '/home/zhx/文档/lxs/NclTest /data/datasets/CIFAR',
        'stl10': '/data/stl10/',
        'imagenet': '/data/imagenet/2012/',
        'cub':'/home/zhx/文档/lxs/WSNFG-master/data/web-bird'
    }
    try:
    ...
    transform_train = transforms.Compose([
        ...
        torchvision.transforms.RandomCrop(size=96),
    ...
    if dataset == 'cifar100':
        ...
        if add_indices_to_data:
            ...
            testset = add_indices(torchvision.datasets.ImageFolder(os.path.join('/home/zhx/文档/lxs/WSNFG-master/data/web-bird', 'val')))
        else:

            testset = torchvision.datasets.ImageFolder(os.path.join('/home/zhx/文档/lxs/WSNFG-master/data/web-bird', 'val'),transform=transform_test)
            clftrainset = torchvision.datasets.ImageFolder(
                os.path.join('/home/zhx/文档/lxs/WSNFG-master/data/web-bird', 'val'), transform=transform_clftrain)

        if num_positive is None:

            trainset = Imagefolder_modified(os.path.join('/home/zhx/文档/lxs/WSNFG-master/data/web-bird', 'train'), transform=transform_train)
            print('train',type(trainset))
        else:

            trainset = MulImagefolder_modified(os.path.join('/home/zhx/文档/lxs/WSNFG-master/data/web-bird', 'train'), transform=transform_train,n_augmentations=num_positive)
